...
void sha256_init(struct sha256_sha224_ctx *ctx)
{
	...
	static word32 H0[_SHA256_SHA224_DIGEST_LENGTH] = {
...
sha256_sha224_update(struct sha256_sha224_ctx *ctx, byte *buffer, word32 length)
{
	 ...
	 * That seems suboptimal, as I suspect it increases the number of branches. */
...
static void sha256_sha224_digest(sha256_sha224_ctx *ctx, byte *s, word32 len)
{
	word32 i;
...
void sha256_digest(sha256_sha224_ctx *ctx, byte * s)
{
	sha256_sha224_digest(ctx, s, SHA256_DIGEST_SIZE / 4);
}

void sha224_digest(sha256_sha224_ctx *ctx, byte * s)
{
