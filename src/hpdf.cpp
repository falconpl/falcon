...
static void registerEnums(Falcon::Module*);
static void registerConsts(Falcon::Module*);
...
static void registerConsts(Falcon::Module* self)
{
  using Falcon::int64;
...
static void registerEnums(Falcon::Module* self)
{
  {
