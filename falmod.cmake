...
ELSE("$ENV{FALCON_INC_PATH}" STREQUAL "" )
   ...
   IF ("$ENV{FALCON_ACTIVE_TREE}" STREQUAL "")
      FILE(TO_CMAKE_PATH "$ENV{FALCON_INC_PATH}" _tmp)
      SET( FALCON_INC_PATH ${_tmp})
      FILE(TO_CMAKE_PATH "$ENV{FALCON_LIB_PATH}" _tmp)
      SET( FALCON_LIB_PATH ${_tmp})
      FILE(TO_CMAKE_PATH "$ENV{FALCON_MOD_INSTALL}" _tmp)
      SET( FALCON_MOD_INSTALL ${_tmp})
   ELSE ("$ENV{FALCON_ACTIVE_TREE}" STREQUAL "")      
      FILE(TO_CMAKE_PATH "$ENV{FALCON_ACTIVE_TREE}/include" _tmp)
      SET( FALCON_INC_PATH ${_tmp})      
      FILE(TO_CMAKE_PATH "$ENV{FALCON_ACTIVE_TREE}/lib" _tmp)
      SET( FALCON_LIB_PATH ${_tmp}) 
      FILE(TO_CMAKE_PATH "$ENV{FALCON_ACTIVE_TREE}/bin" _tmp) 
      LIST(APPEND FALCON_LIB_PATH ${_tmp}) #for backward compatibility with pre 0.9.6 core
      SET( FALCON_MOD_INSTALL ${_tmp})      
