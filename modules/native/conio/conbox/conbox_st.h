...
// Falcon::VMachine::moduleString( conbox_msg_1 ) will
// return the associated string or the internationalized version.
// FAL_STR( conbox_msg_1 ) macro can be used in standard
// functions as a shortcut.

FAL_MODSTR( conbox_msg_1, "An internationalizable message" );
