/* modified version with parts of some useful mhash macros */
...
#define swapendian32(a) \
    ((word32) \
    (((a & (word32) 0x000000ffU) << 24) | \
    ((a & (word32) 0x0000ff00U) << 8)  | \
    ((a & (word32) 0x00ff0000U) >> 8)  | \
    ((a & (word32) 0xff000000U) >> 24))  \
    )

#ifdef BIG_ENDIAN
#  define lend32(n) swapendian32(n)
#else
#  define lend32(n) n
#endif

inline word32 *word32nswap(word32 *buf, word32 n)
{
 ...
 */
void MD4Init(struct MD4_CTX *ctx)
{
