...
namespace Falcon {
    namespace Gtk {
        ...
        /*#
         ...
         @return the action area GtkHBox.
         */
        FALCON_FUNC Dialog::get_action_area( VMARG )
        {
            ...
            vm->retval( new Gtk::HBox( vm->findWKI( "GtkHBox" )->asClass(), (GtkHBox*)wdt ) );
        }
        ...
        FALCON_FUNC Dialog::get_content_area( VMARG )
        {
            ...
            GET_OBJ( self );
            GtkWidget* wdt = gtk_dialog_get_action_area( (GtkDialog*)_obj );
            vm->retval( new Gtk::VBox( vm->findWKI( "GtkVBox" )->asClass(), (GtkVBox*)wdt ) );
        }
