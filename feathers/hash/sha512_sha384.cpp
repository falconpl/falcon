 ...
 * Niels M�ller and Peter Gutmann (see sha256_sha224.c of the mhash library)
 */ 
...
{
  /* Initial values */
	static word64 H0[_SHA512_SHA384_STATE_LENGTH] = {
...
static void 
sha512_sha384_digest(struct sha512_sha384_ctx *ctx, byte * s, word32 len)
{
	word32 i;
...
void sha512_digest(struct sha512_sha384_ctx *ctx, byte * s)
{
	sha512_sha384_digest(ctx, s, SHA512_DIGEST_SIZE / 8);
}

void sha384_digest(struct sha512_sha384_ctx *ctx, byte * s)
{
