...
FALCON_SYNCLASS_DECLARATOR(m_expr_dot, DotAccess, expr)
FALCON_SYNCLASS_DECLARATOR_EX(m_expr_dynsym, GenDynSym, expr, \
...
FALCON_SYNCLASS_DECLARATOR(m_stmt_init, Init, stmt)
