...
public:
   ...
   static void varExprInsert( VMContext* ctx, int pcount, TreeStep* step, bool hasSel = false );
   static void varExprInsert_sel( VMContext* ctx, int pcount, TreeStep* step )
   {
      varExprInsert(ctx, pcount, step, true);
   }
