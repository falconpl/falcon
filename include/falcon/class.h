...
public:
   ...
   */
   ...
   /** Returns true if the instance responds to the given message.
      @param instance The object for which the properties have been requested.
      @param prop The property that is searched.
      ...
      \note The default behavior of this method is to invoke hasProperty.
    */
   virtual bool respondsTo( void* instance, const String& message ) const;
