...
public:
   ...
   /** Fetch a result row */
   virtual dbr_status fetch( CoreArray *resultCache )=0;

   /** Fetch the row headers */
   virtual dbr_status fetchColumns( CoreArray *resultCache )=0;
   
   /** Fetch the number of rows in the recordset or -1 if unknown */
   virtual int fetchRowCount()=0;
   
   /** Fetch the number of columns in the recordset */
   virtual int fetchColumnCount()=0;
