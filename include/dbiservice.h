...
class DBIBaseTrans: public FalconData
{
public:
   DBIBaseTrans() {}
 ...
 * to a CoreObject.
 */
class DBIHandle: public DBIBaseTrans
{
public:
   typedef enum {
      q_no_expansion,
...
class DBITransaction: public DBIBaseTrans
{
protected:
   DBIHandle *m_dbh;
...
public:
   ...
   {
      return m_dbh->escapeString( value, escaped );
   }
