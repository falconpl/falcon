...
//
// Falcon:
// - Added a GC mark member to be able to use
//   Precompiled regular expressions directly in the engine.
...
class RE2 {
 public:
  ...
  static bool Replace(Falcon::String& str,
                        const RE2& pattern,
                        const StringPiece& rewrite);
  ...
  static int GlobalReplace(Falcon::String& str,
                           const RE2& pattern,
                           const StringPiece& rewrite);
