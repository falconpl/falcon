...
//
// FALCON: Modified to use Falcon strings instead of char*/std::string
//
...
class StringPiece {
 ...
 public:
  ...
  // expected.
  StringPiece() : ptr_(NULL), length_(0), buffer_(0) { }
  StringPiece(const char* str)
    : ptr_(str), length_((str == NULL) ? 0 : static_cast<int>(strlen(str))), buffer_(0) { }
