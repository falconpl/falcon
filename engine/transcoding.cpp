...
bool GetSystemEncodingWin(String &encoding)
{
   ...
   case 1200: encoding = "utf-16";	return false; 	//	Unicode UTF-16, little endian byte order (BMP of ISO 10646); available only to managed applications
   case 1201: encoding = "unicodeFFFE";	return false; 	//	Unicode UTF-16, big endian byte order; available only to managed applications
   ...
   case 1252: encoding = "windows-1252";	return false; 	//	ANSI Latin 1; Western European (Windows)
   ...
   case 28591: encoding = "iso-8859-1";	return true; 	//	ISO 8859-1 Latin 1; Western European (ISO)
   case 28592: encoding = "iso-8859-2";	return true; 	//	ISO 8859-2 Central European; Central European (ISO)
   case 28593: encoding = "iso-8859-3";	return true; 	//	ISO 8859-3 Latin 3
   case 28594: encoding = "iso-8859-4";	return true; 	//	ISO 8859-4 Baltic
   case 28595: encoding = "iso-8859-5";	return true; 	//	ISO 8859-5 Cyrillic
   case 28596: encoding = "iso-8859-6";	return true; 	//	ISO 8859-6 Arabic
   case 28597: encoding = "iso-8859-7";	return true; 	//	ISO 8859-7 Greek
   case 28598: encoding = "iso-8859-8";	return true; 	//	ISO 8859-8 Hebrew; Hebrew (ISO-Visual)
   case 28599: encoding = "iso-8859-9";	return true; 	//	ISO 8859-9 Turkish
   case 28603: encoding = "iso-8859-13";	return true; 	//	ISO 8859-13 Estonian
   case 28605: encoding = "iso-8859-15";	return true; 	//	ISO 8859-15 Latin 9
   ...
   case 65000: encoding = "utf-7";	return true; 	//	Unicode (UTF-7)
