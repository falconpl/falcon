/*
   ...
   Falcon core module -- approp function/method
   -------------------------------------------------------------------
...
#undef SRC
#define SRC "falcon/builtin/approp.cpp"

#include <falcon/builtin/approp.h>
#include <falcon/vm.h>
...
void Approp::invoke( VMContext* ctx, int32 )
{
   ...
   public:
      ...
      virtual ~AfterCall() {};
      void describeTo( String& s ) const { s = "Approp::AfterCall"; }
