...
public:
   ...
   */
   ...
   /** Prepares iteration.
    \param vm the virtual machine that will receive the result.
    \param instance the instance (or 0 on flat items)
    \note The operand is unary additive.
    
    \b signature: (0: sequence) --> (0:sequence) (+1: token )
    
    \b signature: (0: sequence) --> (0:break)
    ...
    guaranteed that op_next will be called at the same stack level of op_iter,
   ...
   /** Continues iteration.
    \param vm the virtual machine that will receive the result.
    \param instance the instance (or 0 on flat items)
    \note The operand is binary additive.

    \b signature: (1: seq) (0: iter) --> (1: seq) (0: iter) (+1: item|break)
